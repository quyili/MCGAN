    ...
    with tf.device("/cpu:0"):
        ...
        with tf.variable_scope(tf.get_variable_scope()):
            with tf.device("/gpu:0"):
                with tf.name_scope("GPU_0"):
                    ...
                    loss_list_0, image_list_0, code_list_0, j_list_0 = gan.model(l_x_0, l_y_0, l_z_0, l_w_0, x_0, y_0,
                                                                                 z_0, w_0)
            ...
            with tf.device("/gpu:1"):
                with tf.name_scope("GPU_1"):
                    ...
                    loss_list_1, image_list_1, code_list_1, j_list_1 = gan.model(l_x_1, l_y_1, l_z_1, l_w_1, x_1, y_1,
                                                                                 z_1, w_1)
            ...
            with tf.device("/gpu:2"):
                with tf.name_scope("GPU_2"):
                    ...
                    loss_list_2, image_list_2, code_list_2, j_list_2 = gan.model(l_x_2, l_y_2, l_z_2, l_w_2, x_2, y_2,
                                                                                 z_2, w_2)
            ...
            with tf.device("/gpu:3"):
                with tf.name_scope("GPU_3"):
                    ...
                    loss_list_3, image_list_3, code_list_3, j_list_3 = gan.model(l_x_3, l_y_3, l_z_3, l_w_3, x_3, y_3,
                                                                                 z_3, w_3)
        ...
        with tf.Session(graph=graph, config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            if FLAGS.load_trans_model is not None:
                trans_checkpoints_dir = "checkpoints/" + FLAGS.load_trans_model.lstrip("checkpoints/")
                trans_latest_checkpoint = tf.train.latest_checkpoint(trans_checkpoints_dir)
                trans_saver = tf.train.Saver(variables_list[0] + variables_list[1])
